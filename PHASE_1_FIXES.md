...
- Changed visible in-app ATLAS marks to `atlas-mark.svg`, preventing the broken-image question-mark tile when an app icon is unavailable.
...
5. Use **More → Backup & restore → Refresh app cache**, then fully close and reopen ATLAS.
