(() => {
    ...
    const APP_VERSION = 'nexset-3.1.5';
    ...
    function renderMuscleFigure(day, compact=false) {
      ...
      return `<span class="muscle-figure ${compact?'compact':'hero'} mode-${mode}" aria-hidden="true"><img src="muscle-${mode}-v315.png" alt="" ${compact?'loading="lazy"':''}></span>`;
    }
