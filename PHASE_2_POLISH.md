...
- Added subtle screen-entry transitions.
...
## Preserved
- Existing workout history and body metrics remain in the same local-storage keys.
- No workout-plan data was removed or reset.

## Future coaching phase
A later phase will add progress-aware workout recommendations, optional accessory workouts, and exercise instruction media.
