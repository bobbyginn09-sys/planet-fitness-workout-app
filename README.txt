...
NEXSET 3.1.7 is the branded, iPhone-first redesign of the workout app. It keeps the same saved-data keys as previous PF Workout Coach / NEXSET builds, so existing workout history should remain available when the files are uploaded to the same GitHub Pages address.
...
4. Open the site once with `?nexset=3.1.7` appended.
...
```text
https://bobbyginn09-sys.github.io/planet-fitness-workout-app/?nexset=3.1.7
```
