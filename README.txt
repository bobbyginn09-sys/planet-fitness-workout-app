# ATLAS 2.1 — Workout Coach

ATLAS 2.1 is the branded, iPhone-first redesign of the workout app. It keeps the same saved-data keys as previous PF Workout Coach / Atlas builds, so existing workout history should remain available when the files are uploaded to the same GitHub Pages address.
...
4. Open the site once with `?atlas=2.1` appended.
...
```text
https://bobbyginn09-sys.github.io/planet-fitness-workout-app/?atlas=2.1
```
